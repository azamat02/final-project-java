...
public class KitchenRoom extends BasicRoomDecorator {
    public ArrayList<Device> devices_of_room = new ArrayList<>();
    public ActionHelper helper = new ActionHelper();


    public KitchenRoom(BasicRoomI room) {
        super(room);
    }

    @Override
    public void turn_on_light() {
        System.out.println("Light is turned on in kitchen");
        try {
    ...
    public void turn_off_light() {
        System.out.println("Light is turn off in kitchen");
        try {
            Desktop desktop = java.awt.Desktop.getDesktop();
    ...
    public void close_door() {
        System.out.println("Door is closed in kitchen");
    }
    @Override
    public void open_door() {
        System.out.println("Door is opened in kitchen");
    }
    @Override
    public void open_window() {
        System.out.println("Window is opened in kitchen");
    }
    @Override
    public void close_window() {
        System.out.println("Window is closed in kitchen");
    }
    @Override
    public void clean_up() {
        System.out.println("Robo-cleaner is cleaning in kitchen");
    }
    ...
    public void play_juzz() {
        System.out.println("Juzz music playing in kitchen");
        try {
            Desktop desktop = java.awt.Desktop.getDesktop();
