...
public class HallRoom extends BasicRoomDecorator{
    ...
    public void turn_off_light() {
        System.out.println("Light is turn off in Hall");
        try {
            Desktop desktop = java.awt.Desktop.getDesktop();
    ...
    public void close_door() {
        System.out.println("Door is closed in Hall");
    }
    @Override
    public void open_door() {
        System.out.println("Door is opened in Hall");
    }
    @Override
    public void open_window() {
        System.out.println("Window is opened in Hall");
    }
    @Override
    public void close_window() {
        System.out.println("Window is closed in Hall");
    }
    @Override
    public void clean_up() {
        System.out.println("Robo-cleaner is cleaning in Hall");
    }
    ...
    public void play_juzz() {
        System.out.println("Juzz music playing in Hall");
        try {
            Desktop desktop = java.awt.Desktop.getDesktop();
